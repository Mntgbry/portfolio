...
--
-- Hôte : localhost
-- Généré le : lun. 17 nov. 2025 à 15:27
...
--
-- Base de données : `paris_sportifs_tp`
--
...
(1, 'PSG', 'OM', '2025-11-17 15:08:24', 1),
(2, 'Lakers', 'Bulls', '2025-11-17 15:08:24', 2),
(3, 'Nadal', 'Federer', '2025-11-17 15:08:24', 3);
...
(1, 'Dupont', 'Marc', 'marcdupont@email'),
(2, 'Lopez', 'Sara', 'saralopez@email'),
(3, 'Idrissi', 'Karim', 'karimidrissi@email\r\n');
...
--
ALTER TABLE `gain`
  ADD CONSTRAINT `gain_ibfk_1` FOREIGN KEY (`id_pari`) REFERENCES `pari` (`id_pari`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `matchs`
--
ALTER TABLE `matchs`
  ADD CONSTRAINT `matchs_ibfk_1` FOREIGN KEY (`id_sport`) REFERENCES `sport` (`id_sport`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `pari`
--
ALTER TABLE `pari`
  ADD CONSTRAINT `pari_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `utilisateur` (`id_user`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `pari_ibfk_2` FOREIGN KEY (`id_match`) REFERENCES `matchs` (`id_match`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `pari_ibfk_3` FOREIGN KEY (`id_typepari`) REFERENCES `typepari` (`id_typepari`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
