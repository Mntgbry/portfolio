...
function test_couleur() {
    ...
    } else if (couleur == "bleu" || couleur == "Blue" || couleur == "Bleu" || couleur == "blue") {
        document.body.style.backgroundColor = "blue";
    } else if (couleur == "vert" || couleur == "Green" || couleur == "Vert" || couleur == "green") {
        document.body.style.backgrourndColor = "green";
    } else if (couleur == "rose" || couleur == "Pink" || couleur == "Rose" || couleur == "pink") {
        document.body.style.backgroundColor = "pink";
    } else if (couleur == "rouge" || couleur == "Red" || couleur == "Rouge" || couleur == "red") {
        document.body.style.backgroundColor = "pink";
    } else if (couleur == "jaune" || couleur == "Yellow" || couleur == "Jaune" || couleur == "yellow") {
